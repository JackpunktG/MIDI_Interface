...
int main()
{
    ...
    print_binary_16(controller.active_channels);
    uint8_t i = 0;
    ...
    //         while(1)
    //         {
    //             print_binary_8(command->command.command_byte);
    //             print_binary_8(command->command.param1);
    //             print_binary_8(command->command.param2);
    //             printf("step count: %u\n\n", command->on_tick);
